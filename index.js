...
var timer = setInterval(() => {
    ...
    if (time==5) {
        document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/kindamad.svg";
        document.getElementById('chat').innerHTML = `'Oh yes, the Free Point, it will be mine.'`;
    }
    if (time==00) {
        document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/tickled.svg";
    ...
    if (computerScore>=5) {
        ...
        setTimeout(function(){ document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/tickled.svg"; }, 2000);
        setTimeout(function(){ document.getElementById("npcRighthand").src="/home/mode/repos/TickleSlapPunch/hearts1.svg"; }, 2100);
        setTimeout(function(){ document.getElementById("npcLefthand").src="/home/mode/repos/TickleSlapPunch/hearts2.svg"; }, 2200);
...
function game() {
    function playRound(playerHandsign, computerHandsign) {
        ...
        computerHandsign = computerPlay();
            if (playerHandsign == computerHandsign) {
                ...
                document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/greeting.svg";
                document.getElementById("npcRighthand").src="/home/mode/repos/TickleSlapPunch/hearts1.svg";
                document.getElementById("npcLefthand").src="/home/mode/repos/TickleSlapPunch/hearts2.svg";
                document.getElementById("npcScore").innerHTML = `My Score = ${computerScore}`;
                document.getElementById("yourScore").innerHTML = `Your Score = ${playerScore}`;
                    if (document.getElementById('chat').innerHTML === `'Omg samesies!'`) {
                        document.getElementById('chat').innerHTML = `'We're so in sync I love it!'`;
                        document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/smiley.svg";
                    } else {
                ...
                time = 15;
                 ...
                 document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/saucy.svg";
                 document.getElementById("npcRighthand").src="/home/mode/repos/TickleSlapPunch/rightpunch.svg";
                 document.getElementById("npcLefthand").src="/home/mode/repos/TickleSlapPunch/leftpunch.svg";
                 document.getElementById("npcScore").innerHTML = `My Score = ${computerScore}`;
                 document.getElementById("yourScore").innerHTML = `Your Score = ${playerScore}`;
                    if (document.getElementById('chat').innerHTML === `'Hit ya with a Love Punch! Yay!'`) {
                        ...
                        document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/shock.svg";
                    } else {
                ...
                document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/sleep.svg";
                document.getElementById("npcRighthand").src="/home/mode/repos/TickleSlapPunch/rightslap.svg";
                document.getElementById("npcLefthand").src="/home/mode/repos/TickleSlapPunch/leftslap.svg";
                document.getElementById("npcScore").innerHTML = `My Score = ${computerScore}`;
                document.getElementById("yourScore").innerHTML = `Your Score = ${playerScore}`;
                    if (document.getElementById('chat').innerHTML === `'Can't touch this!' *Tee-hee* 'But maybe next time if you're lucky?'`) {
                        ...
                        document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/indifferent.svg";
                    } else {
                 ...
                 document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/upset.svg";
                 document.getElementById("npcRighthand").src="/home/mode/repos/TickleSlapPunch/righttickle.svg";
                 document.getElementById("npcLefthand").src="/home/mode/repos/TickleSlapPunch/lefttickle.svg";
                 document.getElementById("npcScore").innerHTML = `My Score = ${computerScore}`;
                 document.getElementById("yourScore").innerHTML = `Your Score = ${playerScore}`;
                 ...
                 document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/tickled.svg";
                 document.getElementById("npcRighthand").src="/home/mode/repos/TickleSlapPunch/xrightpunch.svg";
                 document.getElementById("npcLefthand").src="/home/mode/repos/TickleSlapPunch/xleftpunch.svg";
                 document.getElementById("npcScore").innerHTML = `My Score = ${computerScore}`;
                 document.getElementById("yourScore").innerHTML = `Your Score = ${playerScore}`;
                ...
                time = 15;
                  ...
                  document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/confused.svg";
                  document.getElementById("npcRighthand").src="/home/mode/repos/TickleSlapPunch/xrighttickle.svg";
                  document.getElementById("npcLefthand").src="/home/mode/repos/TickleSlapPunch/xlefttickle.svg";
                  document.getElementById("npcScore").innerHTML = `My Score = ${computerScore}`;
                  document.getElementById("yourScore").innerHTML = `Your Score = ${playerScore}`;
                    if (document.getElementById('chat').innerHTML === `'Ooo look at you Mr. Saucy Pants!'`) {
                        ...
                        document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/moreconfused.svg";
                    } else {
                ...
                document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/hurtsgood.svg";
                document.getElementById("npcRighthand").src="/home/mode/repos/TickleSlapPunch/xrightslap.svg";
                document.getElementById("npcLefthand").src="/home/mode/repos/TickleSlapPunch/xleftslap.svg";
                document.getElementById("npcScore").innerHTML = `My Score = ${computerScore}`;
                document.getElementById("yourScore").innerHTML = `Your Score = ${playerScore}`;
                    if (document.getElementById('chat').innerHTML === `'Ow. But it hurts so good!'`) {
                        ...
                        document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/beatup.svg";
                    } else {
    ...
    if (computerScore>=5) {
        ...
        setTimeout(function(){ document.getElementById("npcFace").src="/home/mode/repos/TickleSlapPunch/greeting.svg"; }, 2000);
        setTimeout(function(){ document.getElementById("npcRighthand").src="/home/mode/repos/TickleSlapPunch/hearts1.svg"; }, 2100);
        setTimeout(function(){ document.getElementById("npcLefthand").src="/home/mode/repos/TickleSlapPunch/hearts2.svg"; }, 2200);
